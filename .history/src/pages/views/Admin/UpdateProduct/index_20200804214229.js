...
const UpdateProduct = (props) => {
  ...
  const cates = [];
        ( categoryApi.getAll()).data.map((cate) => {
          cates.push({ label: props.gameUpdate.categories.name + "🍇", value: props.gameUpdate.categories.name, object:props.gameUpdate.categories });
        });
  const [selected, setSelected] = useState(props.gameUpdate.categories);
  ...
  const handleChange = (e) => {
    ...
    console.log(props.gameUpdate.categories);
  };
  return (
    <div>
                ...
                <div className="card-body">
                  <div className="form-group row">
                    ...
                    <div className="col-md">
                      <input
                        ref={register({ required: true , pattern: { value: /\w+/ },})}
                        type="text"
