...
const AllCategory = ({
  ...
  const [getCateUpdate, setCateUpdate] = useState({});
  const [getCateGameUpdate, setCateGameUpdate] = useState({});
  const handleShowUpdate = (category) => {
    setCateGameUpdate(category)
    const options = [];
    category.object.map((game) => {
    options.push({
      label: game.name,
      value: game.name,
      object: game,
  ...
  const onDeleteHandle = (id, name) => {
    confirmAlert({
      ...
      message:
        ...
        name +
        "? If you delete this category, this category will be remove from games. Can not rollback. Do you want to continues?",
      buttons: [
        {
          label: "Yes",
  ...
  const onSubmitSaveOrUpdateHandle = (data) => {
    const defaultValue = {
      games: selected
    };
    const newCate = Object.assign(data, defaultValue);
    console.log(newCate);
  };
  ...
  const datatable = {
    ...
    rows: categories.map((category, index) => ({
      ...
      detail_update: (
        <button className="btn btn-secondary" onClick={() => handleShowUpdate(category)}>
    ...
    <div>
      ...
      <>
        ...
        >
          ...
          <Modal.Body>
            <form method="post" onSubmit={handleSubmit(onSubmitSaveOrUpdateHandle)}>
              ...
              <div className="form-group row">
                ...
                <div className="col-md">
                  <input
                    ...
                    name="name"
                    placeholder="category's name"
                    defaultValue={getCateUpdate.name}
                  />
                  <small id="nameHelp" className="form-text text-danger">
                    {errors.name && <span>This field is required</span>}
                  </small>
              ...
              <div className="form-group row">
                ...
                <div className="col-md">
                  <textarea
                    ...
                    name="description"
                    placeholder="description"
                    defaultValue={getCateUpdate.description}
                  />
                  <small id="nameHelp" className="form-text text-danger">
                  </small>
                </div>
