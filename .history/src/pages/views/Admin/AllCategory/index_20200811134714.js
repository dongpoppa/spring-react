...
const AllCategory = ({
  ...
  const handleShowUpdate = (category) => {
    ...
    const options = [];
    category.object.games.map((game) => {
      options.push({
        label: game.name,
        value: game.name,
        object: game,
      ...
      <>
        ...
        >
          ...
          <Modal.Body>
            <form
              method="post"
              onSubmit={handleSubmit(onSubmitSaveOrUpdateHandle)}
            >
        ...
        >
          ...
          <Modal.Body>
            <form
              ...
              onSubmit={handleSubmit(onSubmitSaveOrUpdateHandle)}
            >
              <input name="id" type="hidden" defaultValue={getCateUpdate.id} ref={register}></input>
              <div className="form-group row">
                <i className="mdi mdi-24px mdi-gamepad-variant" />
                <div className="col-md">
                  <input
