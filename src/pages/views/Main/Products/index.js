...
const Products = (props) => {
    ...
    const setGameDetail = (id) => {
      props.games.filter(game => game.id === id).map(filteredGame => {
            ...
            <div className="col-xl-4 col-md-6" key={index}>
              <div className="product">
                <div className="product_content">
                  <Link to={"/detail?name="+game.name}  onClick={() => setGameDetail(game.id)}>
                    <div className="product_image">
                      <img
                        src={`${process.env.PUBLIC_URL}/static/img/games/${game.image}`}
                        height="180px"
                        width="auto"
                        alt=""
                      />
                    ...
                    <div className="text-right d-flex flex-row align-items-start justify-content-start">
                      <div className="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
                        <div>
                          <div>
                            <img
                              src={require("./../../../../static/user/images/heart_2.svg")}
                              className="svg"
                              alt=""
                            />
                            <div>+</div>
                      ...
                      <div className="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                        <div>
                          <div>
                            <img
                              src={require("./../../../../static/user/images/cart.svg")}
                              className="svg"
                              alt=""
                            />
                            <div>+</div>
